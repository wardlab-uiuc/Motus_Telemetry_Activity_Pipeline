...
#
# If a deployment includes receivers that are missing tower metadata 
# or matching receiver-type thresholds, the deployment is skipped 
# and a warning message is printed. This prevents incomplete or 
# biologically inconsistent activity classifications while still 
# allowing the remaining deployments in the loop to continue processing.
# ------------------------------------------------------------------------------
